...
#include "PSDForUnrealEditorMode.generated.h"
 ...
 */
UCLASS()
class UPSDForUnrealEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_PSDForUnrealEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UPSDForUnrealEditorMode();
	virtual ~UPSDForUnrealEditorMode();
