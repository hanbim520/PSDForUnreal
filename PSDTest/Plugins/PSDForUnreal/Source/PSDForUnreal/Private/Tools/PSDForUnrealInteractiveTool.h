...
#include "PSDForUnrealInteractiveTool.generated.h"


/**
 * Builder for UPSDForUnrealInteractiveTool
 */
UCLASS()
class PSDFORUNREAL_API UPSDForUnrealInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UPSDForUnrealInteractiveTool
 */
UCLASS(Transient)
class PSDFORUNREAL_API UPSDForUnrealInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UPSDForUnrealInteractiveToolProperties();
...
/**
 * UPSDForUnrealInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class PSDFORUNREAL_API UPSDForUnrealInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UPSDForUnrealInteractiveToolProperties> Properties;
